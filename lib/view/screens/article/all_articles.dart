...
// create article model
  ...
  List<Article>   all_articles=[
    Article(name: 'Article title',category: 'category ....',description: 'description of article',selected_tages: ['tag1','tag2'],status: true,privacy: true ),
    Article(name: 'article',category: 'category 2',selected_tages: ['tag1','tag2']),
    Article(name: 'Article title',category: 'category ....',description: 'description of article',selected_tages: ['tag1','tag2'],status: true,privacy: true ),
    Article(name: 'article',category: 'category 2',selected_tages: ['tag1','tag2']),
    Article(name: 'Article title',category: 'category ....',description: 'description of article',selected_tages: ['tag1','tag2'] ),
    Article(name: 'article',category: 'category 2',selected_tages: ['tag1','tag2']),
            ...
            children: [
              ...
              Container(
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children:  [
                      Row(
                        children: [
                          Text('All Articles',style: TextStyle(color: _themeProvider.primaryColorLight,fontWeight: FontWeight.w600,fontSize: 18),)
                      ...
                      GestureDetector(
                          ...
                          child:Container(
                              ...
                              child: Center(child: const Text('Add Article +'))))
                    ],),
                )),
                ...
                NumberPagination(
                  ...
                  pageTotal:(all_articles.length/5).ceil(),
  ...
  return Container(
      ...
      child: Column(children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Expanded(
              child: Text(article.name,style:  TextStyle(
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Expanded(
              child: Text(article.category!,overflow: TextOverflow.ellipsis,style:  TextStyle(
                fontFamily: 'SourceSansPro',
